...
import { FadeIn, SlideUp, SlideIn, StaggerContainer, StaggerItem, ScaleIn } from "@/components/ui";
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-6xl px-6 py-12 sm:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
          <SlideIn from="left" delay={0.1}>
            <div>
              ...
              <StaggerContainer stagger={0.07} delayChildren={0.2} className="mt-6 flex flex-wrap gap-2">
              ...
              <FadeIn delay={0.4} className="mt-8 flex flex-wrap gap-3">
                <Link
                  href="/sign-in"
          ...
          <SlideIn from="right" delay={0.15}>
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
              ...
              <StaggerContainer stagger={0.1} delayChildren={0.1} className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
        ...
        {/* ── Tech Stack ───────────────────────────────────────────── */}
        <SlideUp delay={0.05} className="mt-16 flex flex-col items-center gap-4 border-t border-slate-100 pt-10 text-center">
          <FadeIn className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-slate-400">
            <CheckCircle2 className="h-4 w-4 text-green-600" />
            Tech Stack
          </FadeIn>
          <StaggerContainer stagger={0.05} delayChildren={0.1} className="flex flex-wrap justify-center gap-2">
            {TECH_STACK.map((tech) => (
